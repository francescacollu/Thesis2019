...
The exponential decay of correlation functions implies that the correlation between two sufficiently distant sites is exponentially suppressed: this is due to the absence of long-range order, that is the system is not long-range correlated.
