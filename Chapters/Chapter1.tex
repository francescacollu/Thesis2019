...
Subsystems of a many-body pure state will generally be in a mixed state $\rho$. In the case of mixed states, the measure of entanglement is unclear and diverse; three important representatives~\cite{RevModPhys.80.517, phd_ross} are the following:
\begin{description}
